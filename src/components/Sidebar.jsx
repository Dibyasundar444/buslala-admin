...
const ItemsCenter = 'flex items-center h-12 cursor-pointer text-xl border-b-[1px]';

const RoutesCollapse = [
    {
        id: 1,
        title: "Manage Source",
        route: "/manage-source"
                ...
                <ul className='flex flex-col justify-around h-full'>
                    ...
                    <Collapse in={open} timeout="auto" unmountOnExit>
                        {RoutesCollapse.map(item => (
                            <Link to={item.route}>
                                <List component="div" disablePadding key={item.id} className={ItemsCenter}>
                                    <ListItemButton sx={{ pl: 4 }}>
                                        <ListItemIcon>
                                            <StarBorder />
                                        </ListItemIcon>
